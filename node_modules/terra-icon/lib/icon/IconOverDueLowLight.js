...
var SvgIcon = function SvgIcon(customProps) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('path', { fill: '#F94E4E', d: 'M47.6 34.1s0-.1 0 0L35.7 22.2c-.2-.2-.5-.4-.8-.4s-.6.1-.8.3l-12 12c-.5.4-.5 1.2-.1 1.6 0 0 0 .1.1.1L34 47.6c.5.4 1.1.4 1.6 0l11.9-11.9c.5-.4.5-1.2.1-1.6z' }),
    _react2.default.createElement('path', { fill: '#B1B5B6', d: 'M34 39h2v2h-2v-2zm0-11h2v9h-2v-9z' })
  );
};
